                ...
                <div className="space-y-8">
                    <div className="bg-zinc-950 rounded-card p-10 text-white shadow-2xl shadow-zinc-950/20 sticky top-32 space-y-10">
                        ...
                        <div className="space-y-6">
                            <Button 
                                type="submit"
                                // isLoading={isSubmitting} // Need to check if Button supports isLoading or just disabled
                        ...
                        <div className="space-y-6">
                            {cartItems.map((item) => (
                                <div key={item.id} className="flex gap-4">
                                    <div className="w-16 h-16 rounded-xl bg-muted overflow-hidden border border-border-subtle flex-shrink-0 relative">
